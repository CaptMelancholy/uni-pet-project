...
import { popCard, updateCard } from '../../store/slices/categories/categories.slice';
...
export default function Card({ card }: IProps) {
  ...
  const handleCheckDeadlineClick = () => {
    const updatedCard : ICard = {
      ...
      desc: card.desc,
      deadlineInfo: {
        status: CardsUtils.chooseStatus(card.deadlineInfo!.status, card.deadlineInfo!.deadline_date, card.deadlineInfo?.deadline_time),
